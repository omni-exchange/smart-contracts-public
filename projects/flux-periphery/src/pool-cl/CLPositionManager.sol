...
import {CLPosition} from "flux-core/src/pool-cl/libraries/CLPosition.sol";
import {SafeCast} from "flux-core/src/libraries/SafeCast.sol";
...
/// @notice Contract for modifying liquidity for Omni Exchange Flux CL pools
    ...
    NativeWrapper
{
    ...
    constructor(
        ...
        ERC721Permit("Omni Exchange Flux Positions NFT", "OMNI-FLUX-POSM")
