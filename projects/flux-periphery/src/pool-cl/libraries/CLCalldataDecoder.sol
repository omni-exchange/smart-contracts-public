...
library CLCalldataDecoder {
    ...
    /// @dev equivalent to: abi.decode(params, (IFluxRouter.CLExactInputParams))
    function decodeCLSwapExactInParams(bytes calldata params)
        internal
        pure
        returns (IFluxRouter.CLSwapExactInputParams calldata swapParams)
    {
    ...
    /// @dev equivalent to: abi.decode(params, (IFluxRouter.CLExactInputSingleParams))
    function decodeCLSwapExactInSingleParams(bytes calldata params)
        internal
        pure
        returns (IFluxRouter.CLSwapExactInputSingleParams calldata swapParams)
    {
    ...
    /// @dev equivalent to: abi.decode(params, (IFluxRouter.CLExactOutputParams))
    function decodeCLSwapExactOutParams(bytes calldata params)
        internal
        pure
        returns (IFluxRouter.CLSwapExactOutputParams calldata swapParams)
    {
    ...
    /// @dev equivalent to: abi.decode(params, (IFluxRouter.CLExactOutputSingleParams))
    function decodeCLSwapExactOutSingleParams(bytes calldata params)
        internal
        pure
        returns (IFluxRouter.CLSwapExactOutputSingleParams calldata swapParams)
    {
