...
import {PoolId, PoolIdLibrary} from "flux-core/src/types/PoolId.sol";
...
library CLPositionInfoLibrary {
    ...
    /// @dev This poolId is NOT compatible with the poolId used in flux core. It is truncated to 25 bytes, and just used to lookup PoolKey in the poolKeys mapping.
