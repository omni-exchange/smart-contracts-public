...
library BinCalldataDecoder {
    ...
    /// @dev equivalent to: abi.decode(params, (IFluxRouter.BinExactInputParams))
    function decodeBinSwapExactInParams(bytes calldata params)
        internal
        pure
        returns (IFluxRouter.BinSwapExactInputParams calldata swapParams)
    {
    ...
    /// @dev equivalent to: abi.decode(params, (IFluxRouter.BinExactInputSingleParams))
    function decodeBinSwapExactInSingleParams(bytes calldata params)
        internal
        pure
        returns (IFluxRouter.BinSwapExactInputSingleParams calldata swapParams)
    {
    ...
    /// @dev equivalent to: abi.decode(params, (IFluxRouter.BinExactOutputParams))
    function decodeBinSwapExactOutParams(bytes calldata params)
        internal
        pure
        returns (IFluxRouter.BinSwapExactOutputParams calldata swapParams)
    {
    ...
    /// @dev equivalent to: abi.decode(params, (IFluxRouter.BinExactOutputSingleParams))
    function decodeBinSwapExactOutSingleParams(bytes calldata params)
        internal
        pure
        returns (IFluxRouter.BinSwapExactOutputSingleParams calldata swapParams)
    {
