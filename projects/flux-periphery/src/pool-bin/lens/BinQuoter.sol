...
import {SafeCast} from "flux-core/src/pool-bin/libraries/math/SafeCast.sol";
...
import {BaseFluxQuoter} from "../../base/BaseFluxQuoter.sol";
import {QuoterRevert} from "../../libraries/QuoterRevert.sol";

contract BinQuoter is BaseFluxQuoter, IBinQuoter {
    using QuoterRevert for *;
    using SafeCast for uint128;

    IBinPoolManager public immutable poolManager;

    constructor(address _poolManager) BaseFluxQuoter(_poolManager) {
