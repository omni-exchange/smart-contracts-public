...
import {BalanceDelta} from "flux-core/src/types/BalanceDelta.sol";
...
import {BinPool} from "flux-core/src/pool-bin/libraries/BinPool.sol";
import {PoolKey} from "flux-core/src/types/PoolKey.sol";
import {PoolId} from "flux-core/src/types/PoolId.sol";
import {LiquidityConfigurations} from "flux-core/src/pool-bin/libraries/math/LiquidityConfigurations.sol";
import {BinPoolParametersHelper} from "flux-core/src/pool-bin/libraries/BinPoolParametersHelper.sol";
import {PackedUint128Math} from "flux-core/src/pool-bin/libraries/math/PackedUint128Math.sol";
...
/// @notice Contract for modifying liquidity for Omni Exchange Flux Bin pools
    ...
    NativeWrapper
{
    ...
    function _addLiquidity(
        ...
        /// Slippage checks, similar to CL type. However, this is different from TJ. In Omni Exchange Flux,
