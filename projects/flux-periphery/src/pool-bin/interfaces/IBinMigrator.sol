...
interface IBinMigrator is IBaseMigrator {
    ...
    /// @notice Migrate liquidity from v2 to flux
    /// @param v2PoolParams ncessary info for removing liqudity the source v2 pool
    /// @param fluxPoolParams necessary info for adding liquidity the target flux bin-pool
    ...
    /// @notice Migrate liquidity from v3 to flux
