...
/// @notice Abstract contract for performing a combination of actions on Omni Exchange Flux
...
abstract contract BaseActionsRouter is SafeCallback {
    ...
    /// @notice internal function that triggers the execution of a set of actions on Flux
