...
import {ILockCallback} from "flux-core/src/interfaces/ILockCallback.sol";
import {IVault} from "flux-core/src/interfaces/IVault.sol";
import {ImmutableState} from "./ImmutableState.sol";

/// @title Safe Callback
/// @notice A contract that only allows the Omni Exchange Flux Vault to call the lockAcquired function
