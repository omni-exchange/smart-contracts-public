...
/// @notice Supports quoting the calculated amounts for exact input swaps. Is specialized for routes containing a mix of V2, V3 and flux liquidity.
...
interface IMixedQuoter {
    ...
    struct QuoteMixedFluxExactInputSingleParams {
        PoolKey poolKey;
        bytes hookData;
    }
    ...
    /// FLUX_CL_EXACT_INPUT_SINGLE params are encoded as `QuoteMixedFluxExactInputSingleParams`
    /// FLUX_EXACT_INPUT_SINGLE params are encoded as `QuoteMixedFluxExactInputSingleParams`
    ...
    ///      crossing V2 liquidity pairs and V3 pools.
