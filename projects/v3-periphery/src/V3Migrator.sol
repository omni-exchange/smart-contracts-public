...
import "@omni-exchange/v2-core/contracts/interfaces/IOmniPair.sol";
...
/// @title Omni Exchange V3 Migrator
contract V3Migrator is IV3Migrator, PeripheryImmutableState, PoolInitializer, Multicall, SelfPermit {
    ...
    function migrate(MigrateParams calldata params) external override {
        ...
        IOmniPair(params.pair).transferFrom(msg.sender, params.pair, params.liquidityToMigrate);
        (uint256 amount0V2, uint256 amount1V2) = IOmniPair(params.pair).burn(address(this));
