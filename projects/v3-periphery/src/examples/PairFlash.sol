...
import "@omni-exchange/v3-core/contracts/interfaces/callback/IOmniV3FlashCallback.sol";
...
/// @notice An example contract using the Omni Exchange V3 flash function
contract PairFlash is IOmniV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `OmniV3FlashCallback`
