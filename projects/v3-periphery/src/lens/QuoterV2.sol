...
import "@omni-exchange/v3-core/contracts/libraries/TickBitmap.sol";
import "@omni-exchange/v3-core/contracts/interfaces/IOmniV3Pool.sol";
import "@omni-exchange/v3-core/contracts/interfaces/callback/IOmniV3SwapCallback.sol";
...
contract QuoterV2 is IQuoterV2, IOmniV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IOmniV3Pool;
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IOmniV3Pool) {
        return IOmniV3Pool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IOmniV3SwapCallback
    function omniV3SwapCallback(
        int256 amount0Delta,
        int256 amount1Delta,
        bytes memory path
        ...
        IOmniV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IOmniV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
