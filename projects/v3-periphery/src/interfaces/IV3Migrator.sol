...
/// @title V3 Migrator
/// @notice Enables migration of liqudity from Omni Exchange v2-compatible pairs into Omni Exchange v3 pools
interface IV3Migrator is IMulticall, ISelfPermit, IPoolInitializer {
    struct MigrateParams {
        address pair; // the Omni Exchange v2-compatible pair
